...
export default function SignNegationAlert({text}:{text: string}) {
	...
	return (
		<div id='signAlert' className="flex items-center translate-x-[300px] justify-center transition-all duration-500 gap-[10px] bg-red-500 px-[15px] py-[8px] rounded-[9px] z-[100] absolute top-[20px] right-[20px]">
